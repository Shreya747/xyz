package mindtree.myntraCucumber.base;
...
public class browserBase {
	...
	public browserBase() {
		...
		spark.config().setDocumentTitle("Test Report Myntra");
		spark.config().setReportName("Test Report Myntra");
	...
	public WebDriver initializeBrowser() {
		try {
			...
			FileInputStream fis = new FileInputStream(
					"C:\\Users\\M1072987\\eclipse-workspace\\MyntraCucumber\\src\\main\\java\\resources\\prop.properties");
	...
	public void getScreenshot(String result) {
		try {
			...
			FileUtils.copyFile(src,
					new File("C:\\Users\\M1072987\\eclipse-workspace\\MyntraCucumber\\Screenshot\\screenshot.png"));
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
